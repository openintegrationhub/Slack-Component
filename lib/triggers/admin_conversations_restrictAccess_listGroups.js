 ...
 *
 *
 * Operation: 'admin_conversations_restrictAccess_listGroups'
 * Endpoint Path: '/admin.conversations.restrictAccess.listGroups'
 * Method: 'get'
 *
 */
   ...
   const applicationUid = msg.metadata !== undefined && msg.metadata.applicationUid !== undefined
    ...
    securities['slackAuth'] = { token = { access_token: cfg['accessToken']} };
     ...
     let callParams = {
         ...
         pathName: '/admin.conversations.restrictAccess.listGroups',
         method: 'get',
