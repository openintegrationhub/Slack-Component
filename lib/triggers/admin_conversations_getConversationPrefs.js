 ...
 *
 *
 * Operation: 'admin_conversations_getConversationPrefs'
 * Endpoint Path: '/admin.conversations.getConversationPrefs'
 * Method: 'get'
 *
 */
   ...
   const applicationUid = msg.metadata !== undefined && msg.metadata.applicationUid !== undefined
    ...
    securities['slackAuth'] = { token = { access_token: cfg['accessToken']} };
     ...
     let callParams = {
         ...
         pathName: '/admin.conversations.getConversationPrefs',
         method: 'get',
